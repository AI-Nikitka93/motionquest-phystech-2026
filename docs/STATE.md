...
current_task: Fix seated-adaptive and Reach Stars for close seated PC webcam framing.
status: Seated Adaptive and Reach Stars now use hand-only tracking: seated/reach modes ignore PoseLandmarker body, shoulder, elbow and wrist landmarks; only real HandLandmarker wrist data can make a usable stage or draw hand markers.
active_step: Contest-winning product upgrade.
next_step: User should hard-refresh `https://motionquest-app.vercel.app`, run seated-adaptive and Reach Stars with one open hand visible, then save screenshots and `Copy live evidence` output in `evidence/camera-smoke/` if live tracking still fails.
...
artifacts: docs/mvp-plan.md, docs/visual-spec.md, docs/CONDITIONS_GAP_AUDIT.md, docs/CONDITIONS_GAP_ACTION_CHECKLIST.md, docs/JUDGING_CLAIMS_AND_LIMITS.md, docs/SUBMISSION_PACKAGE_PLAN.md, docs/MASTER_TODO_WINNING_PROJECT.md, docs/DEVPOST_SUBMISSION_COPY.md, docs/PRESENTATION_SCRIPT.md, docs/JUDGE_QA_ANSWER_BANK.md, docs/FINAL_SUBMISSION_CHECKLIST.md, docs/FINAL_REHEARSAL_PLAN.md, docs/RELEASE_RISK_REGISTER.md, docs/RELEASE_EVIDENCE_2026_05_05.md, docs/PHASE5_T086_T105_REAL_CAMERA_CLOSEOUT.md, docs/POST_CONTEST_CONTINUITY.md, docs/ADAPTIVE_SEATED_METRICS_RESEARCH_2026_05_05.md, docs/ADAPTIVE_SEATED_IMPLEMENTATION_2026_05_05.md, output/devpost-screenshots/01-home-desktop.png, output/devpost-screenshots/02-seated-adaptive-stage.png, output/devpost-screenshots/03-reach-stars-stage.png, output/devpost-screenshots/04-caregiver-report.png, output/devpost-screenshots/05-home-mobile.png, output/demo-video/motionquest-adaptive-demo.webm, output/playwright/reach-stars-layout-after-tracking-gate-fix.png, output/playwright/seated-hand-only-local.png, output/playwright/seated-hand-only-production.png, evidence/camera-smoke/README.md, research-synthesis-MotionQuest.md, motionquest-app/, https://github.com/AI-Nikitka93/motionquest-phystech-2026
updated_at: 2026-05-05 19:04 Europe/Minsk
...
Deployment status: Vercel production is ready at `https://motionquest-app.vercel.app`. Latest deployment id is `dpl_2cZWQerAMoowNVrKM56ySApA5p7j`. MediaPipe wasm/model URLs are CDN-hosted and returned HTTP 200 during deploy verification.
