...
- Deployment id: `dpl_B1m73Bmz1xCwsR2A4CANH6DKKLFK`.
...
- Pose overlay now rejects single-limb/partial-body noise and supports seated upper-body tracking, but real-room camera distance, lighting and framing still need physical smoke testing.
